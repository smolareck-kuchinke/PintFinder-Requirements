...
PintFinder ist eine Plattform zur Bewertung von Guinness in Berliner Bars, Pubs und Kneipen. User können Bars suchen, Bewertungen abgeben, Bilder hochladen und andere Erfahrungen kommentieren.
...
### Vorgehensmodell
Iterativ und agil. Anforderungen werden folglich schrittweise entwickelt, validiert und erweitert.

---

## 3. Stakeholder-Analyse
Wichtige Stakeholder sind Endnutzer, Pub-Betreiber, Plattformbetreiber und Entwickler. Nutzer erwarten gute Empfehlungen und einfache Bedienung. Betreiber möchten Sichtbarkeit und faire Bewertungen.

## 4. Datenanalyse
Verarbeitet werden Benutzer-, Bewertungs-, Bild- und Standortdaten. Zusätzlich entstehen technische Metadaten wie Logdaten und Zeitstempel. Datenschutz und Datensicherheit spielen daher eine wichtige Rolle.

## 5. Anforderungsebene
Funktionale Anforderungen sind Registrierung, Bewertungen, Bild-Upload, Kartenansicht und Suchfunktion. Nichtfunktionale Anforderungen betreffen Benutzerfreundlichkeit, Sicherheit, Datenschutz und Skalierbarkeit. Die Kernfunktionen wurden als MVP priorisiert.
...
Zu den wichtigsten Kostenfaktoren zählen Hosting, API-Nutzung, Bildspeicherung, Moderation und die Weiterentwicklung.
